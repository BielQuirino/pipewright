...
- Dismissing or belittling contributions based on skill level or experience
...
This Code of Conduct applies within all community spaces — GitHub issues, pull requests, discussions, and any other official project channel. It also applies when an individual is officially representing the project in public spaces.

---

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported by opening a GitHub issue marked as `[conduct]` or by contacting the maintainers directly through GitHub.
